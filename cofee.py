...
menu = (" coffee , green tea, juice , falloda")

if name == "Alen" or name == "kj" or name == "loki":
    answer = input(" Hey, are you evil \n")
    evil_check = int(input(" How many good deeds have you done today? \n"))
    
    if answer == "yes" and evil_check <= 4:
        print(" GET OUT .....!")
        exit()
